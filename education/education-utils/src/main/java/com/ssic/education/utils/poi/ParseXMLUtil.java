...
public class ParseXMLUtil {
	...
	/**
	 * rules map 对象, key:entityName_colName, value: rules
	...
	public ParseXMLUtil(File xmlFilePath) {
		...
		try {
			...
			while (it.hasNext()) {
				...
				System.out.println("entity properties:" + uu + " = "
						+ enMap.get(uu));
			}
	...
	@SuppressWarnings("unchecked")
	public void setRuleMap(String entityName, String columnName,
			Element ruleValid) {
		if (ruleValid != null) {
