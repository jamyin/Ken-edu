...
import com.ssic.education.admin.mapper.TImsMenuExMapper;
import com.ssic.education.admin.mapper.TImsMenuTypeExMapper;
import com.ssic.education.admin.mapper.TImsRoleMenuExMapper;
import com.ssic.education.admin.mapper.TImsUserRoleExMapper;
import com.ssic.education.admin.mapper.TImsUsersExMapper;
...
import com.ssic.education.admin.util.MyComparator;
		...
		if (!CollectionUtils.isEmpty(menuList)) {
			for (Menu m : menuList) {
				...
				if (m != null) {
					...
					MenuType menuType = tImsMenuTypeExMapper.findById(m
							.getMenuTypeId());
