package com.ssic.education.manage.service.impl;
...
public class ProjectServiceImpl implements ProjectService
{
    ...
    @CacheEvict(value="default", key = "'education.common.dto.ProjectDto:' + #projectDto.getId()", beforeInvocation=true)
...
*/
   ...
   /*     if (list != null && list.size() > 0)
    ...
    /** 
    * (non-Javadoc)   
    * @see com.ssic.education.admin.service.ProjectService#allTree()   
    */
    @Override
