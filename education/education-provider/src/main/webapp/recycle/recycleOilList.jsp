...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			url : '${pageContext.request.contextPath}/recycleOilControllor/dataGrid',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
	...
	function addFun() {
		parent.$.modalDialog({
			...
			width : 700,
			height : 800,
			href : '${pageContext.request.contextPath}/recycleOilControllor/addRecycleOil',
			buttons : [ {
				text : '添加',
				handler : function() {
					parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
		...
		<div data-options="region:'north',title:'查询条件',border:false" style="height: 160px; overflow: hidden;">
			<form id="searchForm">
				<table class="table table-hover table-condensed" style="display: none;">
					<tr>
						<th>回收日期</th>
						<td><input class="span2" name="recycleDate" onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" /></td>
					</tr>
